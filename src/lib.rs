...
impl Ball {
    ...
    fn get_initial_speed() -> Vec3 {
        ...
        // Que incie en un lugar aleatorio y que no sea 0.
        Vec3::new(
...
impl Racket {
    ...
    fn racket_ai(
        ...
        // Movimiento de la bola hacia el jugador
        ...
        // Movimiento con centro guardado

        let diff = self.ai_last_ball_ypos - self_transform.translation.y;
        let distance = diff.abs();

        // Si no esta en una distancia adecuada para moverse entonces: Quieto
...
fn racket(
    ...
    // Velocidad de la bola para saber a donde va
